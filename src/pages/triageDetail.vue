  ...
  <tk-container class :status="status">
    ...
    <div class="p-x-15 box-bb bg-white">
      <div class="p-y-16 m-b-10">
        <div class="font-14 m-b-10">国务院颁布国家最新商铺增收最新商铺增商铺增收税收税收政策</div>
        <Images type="triage" width="100%" :imgs="imgs"></Images>
      ...
      <div class="reply box-bb p-10">
        <div v-for="(item,index) in replyArr" :key="index" class="color-light-gray font-13 m-b-12">
          <span class="color-black">{{item.type?'平台回复：':'我回复：'}}</span>
          {{item.content}}
        </div>
  ...
  data () {
    return {
      ...
      replyArr: [
        {
          type: 1,
          content: '您好，您需要携带个人相关资料到村务部办理此事项。'
        },
        { type: 0, content: '好的。' }
      ],
      imgs: [
        'http://moke-store.oss-cn-beijing.aliyuncs.com/11571c3e-8771-44ed-896d-1243249a0ef1.png',
        'http://moke-store.oss-cn-beijing.aliyuncs.com/11571c3e-8771-44ed-896d-1243249a0ef1.png',
        'http://moke-store.oss-cn-beijing.aliyuncs.com/11571c3e-8771-44ed-896d-1243249a0ef1.png',
        'http://moke-store.oss-cn-beijing.aliyuncs.com/11571c3e-8771-44ed-896d-1243249a0ef1.png'
      ], // 测试图片数据
      // imgs:["http://moke-store.oss-cn-beijing.aliyuncs.com/11571c3e-8771-44ed-896d-1243249a0ef1.png"],//测试图片数据
      replyCon: '',
      inputBox: false
    }
  },
